...
function HeroSection() {
  return (
    <div className='min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 '>
     ...
     <h1 className='font-bold text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-cyan-300 tracking-wide '>TUSHAR BHARDWAJ</h1>
     <h2 className='text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold  text-white/70  mt-2 sm:mt-3'>SOFTWARE </h2>
      <h2 className='text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold  text-white/40  mt-2 inline-flex items-baseline flex-wrap gap-2'>DEVELOPER
     ...
     <div className='mt-6 sm:mt-8 md:mt-10 mx-auto'>
      ...
      <p className='text-white/30 -mt-5 text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-relaxed px-2'>
